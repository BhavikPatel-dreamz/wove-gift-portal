...
<body>
  ...
  <div class="summary-section">
    ...
    <div class="metric-row">
      ...
      <span class="metric-value">${(salesSummary.totalOrders || 0).toLocaleString()}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Total Revenue</span>
      <span class="metric-value">${formatCurrency(salesSummary.totalRevenue)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Average Order Value</span>
      <span class="metric-value">${formatCurrency(salesSummary.avgOrderValue)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Total Discount</span>
      <span class="metric-value">${formatCurrency(salesSummary.totalDiscount)}</span>
    </div>
  </div>
  ...
  <div class="summary-section">
    ...
    <div class="metric-row">
      <span class="metric-label">Total Vouchers Issued</span>
      <span class="metric-value">${(redemptionSummary.totalIssued || 0).toLocaleString()}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Vouchers Redeemed</span>
      <span class="metric-value">${(redemptionSummary.totalRedeemed || 0).toLocaleString()}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Redemption Rate</span>
      <span class="metric-value">${redemptionSummary.redemptionRate || 0}%</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Issued Value</span>
      <span class="metric-value">${formatCurrency(redemptionSummary.totalIssuedValue)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Redeemed Value</span>
      <span class="metric-value">${formatCurrency(redemptionSummary.totalRedeemedValue)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Remaining Value</span>
      <span class="metric-value">${formatCurrency(redemptionSummary.totalRemainingValue)}</span>
    </div>
  </div>
  ...
  <div class="summary-section">
    ...
    <div class="metric-row">
      <span class="metric-label">Period Sold/Redeemed Amount</span>
      <span class="metric-value">${formatCurrency(settlementSummary.periodTotalSoldAmount)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Period Commission</span>
      <span class="metric-value">${formatCurrency(settlementSummary.periodTotalCommission)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Period VAT</span>
      <span class="metric-value">${formatCurrency(settlementSummary.periodTotalVAT)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Period Net Payable</span>
      <span class="metric-value">${formatCurrency(settlementSummary.periodTotalNetPayable)}</span>
    </div>
  </div>
  ...
  <div class="summary-section">
    ...
    <div class="metric-row">
      ...
      <span class="metric-value">${(brandSummary.totalBrands || 0).toLocaleString()}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Total Revenue</span>
      <span class="metric-value">${formatCurrency(brandSummary.totalRevenue)}</span>
    </div>
    <div class="metric-row">
      <span class="metric-label">Avg Redemption Rate</span>
      <span class="metric-value">${brandSummary.avgRedemptionRate || 0}%</span>
    </div>
  </div>
