  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex flex-col h-full max-h-[90vh] ">
        {/* Blue Header */}
        <div className="bg-[#1F59EE] text-white px-8 py-6 rounded-t-2xl flex-shrink-0">
          ...
          <div className="px-8 py-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="w-[170px] bg-[#1F59EE] text-white flex items-center justify-center gap-2"
                  onClick={handleSave}
            ...
            <div className="border border-gray-300  rounded-lg p-4">
              <div className="mb-6">
                <h3 className="text-base font-medium text-[#4A4A4A] mb-4">Occasion Image<span className="text-gray-800">*</span></h3>
                <ImageUpload />
              </div>
            </div>
