    ...
    <div className="w-full">
      <div className="bg-white px-5 py-6 rounded-lg border border-gray-200">
        <div className="">
          ...
          <div className="rounded-lg  border-t border-gray-200 pt-6">
              ...
              <div className="grid grid-cols-4 gap-3 items-end">
                ...
                <div className="col-span-1">
                  <button
                    ...
                    className="w-[140px] items-end justify-end bg-blue-600 hover:bg-blue-700 text-white px-2 py-3 rounded-md text-sm font-medium transition-colors"
                  >
                    + Add New Brand
                  </button>
                </div>
          ...
          {formData.denominations?.length > 0 && (
            <div className="space-y-3 pt-6">
              <h4 className="text-[16px] font-semibold text-[#4A4A4A]">
                Active Denomination (
