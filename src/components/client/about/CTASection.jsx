  ...
  return (
    <div className="py-20 px-6 bg-wave-cream">
      <div className="max-w-2xl mx-auto">
        <div className="bg-wave-orange rounded-3xl p-12 text-center text-white relative overflow-hidden shadow-brand-lg">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white hover:bg-wave-cream text-wave-green px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
                {primaryButtonText}
              </button>
