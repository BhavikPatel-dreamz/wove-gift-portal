                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full p-4 sm:p-6 flex justify-between items-start gap-3 hover:bg-gray-50 transition-colors duration-200"
                    >
          ...
          <div className="max-w-4xl mx-auto rounded-2xl sm:rounded-3xl p-px bg-linear-to-r from-pink-500 to-orange-400">
            <div className="rounded-2xl sm:rounded-3xl bg-linear-to-br from-pink-50 to-orange-50 p-6 sm:p-10 lg:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                ...
                <button className="bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-3.5 rounded-full font-semibold hover:shadow-lg transition-shadow duration-200 flex items-center justify-center gap-2">
