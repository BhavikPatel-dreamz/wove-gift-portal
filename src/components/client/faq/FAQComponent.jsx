...
const FAQComponent = () => {
 ...
 <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {categories.map((category) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-medium transition-all duration-200 text-base ${
        ...
        <div className="space-y-4 mb-16">
          {faqData[activeCategory] && faqData[activeCategory].map((faq, index) => {
            ...
            return (
              <div
                key={key}
                className="bg-white rounded-2xl border border-gray-200 hover:border-linear-gradient(114.06deg, #ED457D 11.36%, #FA8F42 90.28%) transition-colors duration-200 overflow-hidden"
              ...
              >
                ...
                >
                  ...
                  <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center relative transition-transform duration-200">
                    {isExpanded ? (
      ...
      <div className="max-w-5xl mx-auto px-4 pb-20">
        <div className="max-w-4xl mx-auto rounded-3xl p-[1px] bg-gradient-to-r from-pink-500 to-orange-400">
          <div className="rounded-3xl bg-gradient-to-br from-pink-50 to-orange-50 p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="bg-gradient-to-r from-pink-500 to-orange-400 text-white px-8 py-3.5 rounded-full font-semibold hover:shadow-lg transition-shadow duration-200 flex items-center justify-center gap-2">
              ...
              <button className="bg-green-500 text-white px-8 py-3.5 rounded-full font-semibold hover:shadow-lg transition-shadow duration-200 flex items-center justify-center gap-2">
