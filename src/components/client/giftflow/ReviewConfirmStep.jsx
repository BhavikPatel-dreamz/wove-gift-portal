            ...
            <div className="rounded-[20px] border-[1.5px] border-dashed border-[#ED457D] bg-[rgba(244,236,217,0.5)] p-6 mt-6 text-center">
              <div className="flex gap-2 items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                  <path d="M13.7891 3.94818V7.61517C13.7891 10.0991 12.7734 11.9047 11.5537 13.1415C10.3919 14.3197 9.06786 14.9571 8.30762 15.1533C7.54728 14.9569 6.22305 14.3194 5.06152 13.1415C3.84194 11.9047 2.82715 10.0989 2.82715 7.61517V3.94818L8.30762 1.51263L13.7891 3.94818Z" stroke="#1A1A1A" stroke-width="1.5" />
                </svg>
