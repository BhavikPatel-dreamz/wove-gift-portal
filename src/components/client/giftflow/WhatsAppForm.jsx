...
const WhatsAppForm = ({
  ...
  return (
    <div className="text-black">
      ...
      {/* Main Content */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-0 sm:px-4 lg:px-8 pb-6">
        {/* Left Side - Form */}
        <div className="space-y-6">
          {/* Your Details Section */}
          <div className="rounded-2xl border border-gray-200">
            <div className="bg-[#f7eef2] flex items-start mb-4 border-b border-[#f83c91] p-4 rounded-t-2xl">
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center mr-3 shrink-0">
                <div className="absolute inset-0 bg-[#f83c91] opacity-20 rounded-2xl"></div>
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Tell us who is sending the gift
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 m-4 sm:m-6">
              <div>
                <input
                  ...
                  className={`w-full p-3.5 border rounded-xl focus:ring-2 focus:outline-none transition-all bg-white text-sm ${errors.yourName
                      ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                      : "border-gray-200 focus:ring-[#f83c91] focus:border-[#f83c91]"
                    }`}
                />
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <select
                    ...
                    className="w-full sm:w-[170px] p-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#f83c91] focus:border-[#f83c91] outline-none transition-all bg-white text-sm"
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className={`w-full p-3.5 border rounded-xl focus:ring-2 focus:outline-none transition-all bg-white text-sm ${errors.yourWhatsAppNumber
                          ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                          : "border-gray-200 focus:ring-[#f83c91] focus:border-[#f83c91]"
                        }`}
                    />
          ...
          <div className="rounded-2xl border border-gray-200">
            <div className="bg-[#ececec] flex items-start mb-4 border-b border-[#ff6504] p-4 rounded-t-2xl">
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center mr-3 shrink-0">
                <div className="absolute inset-0 bg-[#ff6504] opacity-20 rounded-2xl"></div>
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  We’ll use these details in the message you send
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 m-4 sm:m-6">
              <div>
                <input
                  ...
                  className={`w-full p-3.5 border rounded-xl focus:ring-2 focus:outline-none transition-all bg-white text-sm ${errors.recipientName
                      ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                      : "border-gray-200 focus:ring-[#ff6504] focus:border-[#ff6504]"
                    }`}
                />
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <select
                    ...
                    className="w-full sm:w-[170px] p-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#ff6504] focus:border-[#ff6504] outline-none transition-all bg-white text-sm"
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className={`w-full p-3.5 border rounded-xl focus:ring-2 focus:outline-none transition-all bg-white text-sm ${errors.recipientWhatsAppNumber
                          ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                          : "border-gray-200 focus:ring-[#ff6504] focus:border-[#ff6504]"
                        }`}
                    />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 relative">
          ...
          <div className="absolute h-[260px] w-[260px] sm:h-[300px] sm:w-[300px] lg:h-[500px] lg:w-[500px] bg-gradient-to-br from-green-100 to-green-200 rounded-full opacity-40 blur-3xl -z-10"></div>
