...
import { Search, Download, ChevronDown, Eye, Gift, Calendar, Copy, ChevronLeft, ChevronRight, AlertCircle } from 'lucide-react';
...
function MyGift() {
  ...
  }, [activeTab, currentPage, debouncedSearch, startDate, endDate]);
    ...
    <div className="min-h-screen py-8 sm:py-30 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-3 sm:gap-4">
            ...
            <div className="relative" ref={datePickerRef}>
              <div className="relative">
                ...
                {isDatePickerOpen && (
                  <div className="absolute top-full left-0 z-50 mt-1 shadow-lg rounded-md">
                    <ReactDatePicker
                      selected={startDate}
      ...
      {isModalOpen && (
        <GiftCardDetailModal
          card={selectedCard}
          onClose={closeModal}
          onRedeem={() => alert('Redeem functionality to be implemented')}
        />
      )}
    </div >
  );
