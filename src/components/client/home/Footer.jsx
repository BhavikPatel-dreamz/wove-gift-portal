                ...
                <div key={index} className="w-10 h-10 bg-[linear-gradient(114.06deg,#ED457D_11.36%,#FA8F42_90.28%)]
                 ...
                 transition-all duration-300 rounded-[10px]">
                  <a
                    ...
                    aria-label={label}
                    className="w-[38px] h-[38px] rounded-[10px] bg-white
                 flex items-center justify-center 
                 "
                  >
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className=" group bg-[linear-gradient(114.06deg,#ED457D_11.36%,#FA8F42_90.28%)] text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:shadow-lg  transition-all duration-300 flex items-center justify-center gap-2 w-fit cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
