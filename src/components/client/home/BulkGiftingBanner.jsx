                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="z-10 max-w-xl order-2 md:order-1 text-center md:text-left">
                        ...
                        <Link
                            href="/gift?mode=bulk"
                            onClick={handleClick}
                            className="group bg-linear-to-r cursor-pointer max-w-fit from-pink-500 to-orange-400 text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-full hover:shadow-lg transition-all duration-300 flex items-center gap-2 mb-4 md:mb-6 hover:scale-105 mx-auto md:mx-0 text-sm md:text-base"
                        >
