...
-- CreateEnum
CREATE TYPE "SettlementFrequencyStatus" AS ENUM ('daily', 'weekly', 'monthly', 'quarterly', 'yearly');
...
CREATE TABLE "BrandTerms" (
    ...
    "breakagePolicy" TEXT,
    "breakageShare" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE "vouchers" (
    ...
    "denominationValue" DOUBLE PRECISION,
...
CREATE TABLE "Settlements" (
    ...
    "totalSoldAmount" DOUBLE PRECISION NOT NULL,
    "totalRedeemed" INTEGER NOT NULL,
    "redeemedAmount" DOUBLE PRECISION NOT NULL,
    "outstanding" INTEGER NOT NULL,
    "outstandingAmount" DOUBLE PRECISION NOT NULL,
    "commissionAmount" DOUBLE PRECISION NOT NULL,
    "breakageAmount" DOUBLE PRECISION,
