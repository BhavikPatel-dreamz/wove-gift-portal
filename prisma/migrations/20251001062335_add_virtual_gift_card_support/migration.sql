...
-- CreateEnum
CREATE TYPE "public"."SyncStatus" AS ENUM ('success', 'failed', 'partial', 'in_progress');
...
CREATE TABLE "public"."BrandTerms" (
    ...
    "breakagePolicy" "public"."PolicyStatus" DEFAULT 'Retain',
...
-- AddForeignKey
ALTER TABLE "public"."VoucherCode" ADD CONSTRAINT "VoucherCode_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "public"."Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."VoucherCode" ADD CONSTRAINT "VoucherCode_voucherId_fkey" FOREIGN KEY ("voucherId") REFERENCES "public"."Vouchers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."DeliveryLog" ADD CONSTRAINT "DeliveryLog_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "public"."Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."DeliveryLog" ADD CONSTRAINT "DeliveryLog_voucherCodeId_fkey" FOREIGN KEY ("voucherCodeId") REFERENCES "public"."VoucherCode"("id") ON DELETE SET NULL ON UPDATE CASCADE;
